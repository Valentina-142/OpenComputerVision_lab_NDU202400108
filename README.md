...
Write a program to compute and plot the histogram of a grayscale image and perform histogram
equalization.
...
Design and implement an image segmentation framework using both classical (thresholding, regionbased) and learning-based approaches. Compare their performance on natural images.
